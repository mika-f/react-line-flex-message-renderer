import FlexMessageJSON from "@ohmyteeth/line-flex-message-renderer-sample-fixtures/fixtures/menu.json" with { type: "json" };
import { FlexMessageRenderer } from "@ohmyteeth/react-line-flex-message-renderer";
import type { Meta, StoryObj } from "@storybook/react-vite";

const meta = {
  title: "FlexMessage/Menu",
...
export const Primary: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvasElement).toMatchScreenshot("menu-rendered");
  },
};
