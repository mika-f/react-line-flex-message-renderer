import FlexMessageJSON from "@ohmyteeth/line-flex-message-renderer-sample-fixtures/fixtures/ticket.json" with { type: "json" };
import { FlexMessageRenderer } from "@ohmyteeth/react-line-flex-message-renderer";
import type { Meta, StoryObj } from "@storybook/react-vite";
import { expect } from "vitest";

const meta = {
  title: "FlexMessage/Ticket",
...
export const Primary: Story = {
  ...
  play: async ({ canvasElement }) => {
    await expect(canvasElement).toMatchScreenshot("ticket-rendered");
  },
};
